...
# Get argument first
#nnPath = str(Path("models/tiny-yolo-v3_openvino_2021.2_6shave.blob").resolve().absolute())
nnPath = str(Path("models/detect.blob").resolve().absolute())
...
if args.camera:
    ...
    det_xin.out.link(detectionNetwork.input)
...
with dai.Device(pipeline) as device:
    ...
    if args.camera:
        ...
        det_in = device.getInputQueue("det_in", maxSize=4, blocking=False)
